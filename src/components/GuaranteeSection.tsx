      ...
      <div className="container mx-auto px-4 max-w-3xl text-center">
        ...
        <div className="bg-[#16293B] border border-[#E0932E]/20 rounded-3xl p-4 md:p-8 shadow-sm">
          <p className="text-sm md:text-base text-[#93A7B8] leading-relaxed mb-4 md:mb-6">
            Tenés 7 días para revisar el Sistema Blindaje Quirúrgico
            2026™. Si el contenido no se corresponde con lo ofrecido en
            esta página, podés solicitar la devolución según las
            condiciones de compra. Sin preguntas difíciles.
          </p>
